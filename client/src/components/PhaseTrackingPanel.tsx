    ...
    <Card className={`mt-3 border-emerald-100 bg-emerald-50/30 ${compact ? "p-3" : "p-4"}`}>
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="grid flex-1 gap-2 sm:grid-cols-3">
          ...
          <div><p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground">Suporte externo</p><p className="mt-1 text-sm font-semibold">{[phase.supportName, phase.supportCompany].filter(Boolean).join(" — ") || "Por definir"}</p></div>
