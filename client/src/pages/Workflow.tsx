          ...
          <CardContent className="space-y-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="flex items-start gap-2 p-2 rounded-md bg-background border">
                ...
                <div>
                  <p className="font-medium">Entidade Executante</p>
              ...
              <div className="flex items-start gap-2 p-2 rounded-md bg-background border">
                ...
                <div>
                  <p className="font-medium">Dono de Obra</p>
      ...
      <div className="flex flex-col items-center gap-0">
        ...
        <div className="relative w-full max-w-lg">
          <div className="border-2 border-dashed border-muted-foreground/30 rounded-xl p-4 bg-muted/20">
            <p className="text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-4">Decisão da RAA</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Approved path */}
              <div className="flex flex-col items-center gap-2">
                <div className="w-full p-3 rounded-lg bg-green-50 border border-green-200 text-center">
                  <CheckCircle2 className="w-6 h-6 text-green-600 mx-auto mb-1" />
                  <p className="text-sm font-semibold text-green-800">Aprovada</p>
