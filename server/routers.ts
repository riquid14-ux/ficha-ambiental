...
const INFRASTRUCTURE_SYSTEM_TYPES = ["energia", "hall_ti", "arrefecimento", "agua_mar", "pessoa", "infraestrutura", "futuro"] as const;
...
export const INFRASTRUCTURE_REFERENCE_POINTS = [
  { title: "Ponto de infraestrutura 01", subtitle: "A identificar", systemType: "agua_mar", status: "a_validar", xPercent: 41, yPercent: 37, description: "Marcador amarelo de referência. Configure o título, dados, gráfico, documentos e nota técnica na Administração.", metricCodes: [], chartMetricCode: null, technicalNote: "Posição inicial baseada na marcação aprovada; confirme a infraestrutura em campo.", isFuture: false, sortOrder: 10 },
  { title: "Ponto de infraestrutura 02", subtitle: "A identificar", systemType: "agua_mar", status: "a_validar", xPercent: 46, yPercent: 30, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Posição inicial baseada na marcação aprovada; pode ser reposicionada.", isFuture: false, sortOrder: 20 },
  { title: "Ponto de infraestrutura 03", subtitle: "A identificar", systemType: "agua_mar", status: "a_validar", xPercent: 50, yPercent: 41, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Posição inicial baseada na marcação aprovada; pode ser reposicionada.", isFuture: false, sortOrder: 30 },
  { title: "Ponto de infraestrutura 04", subtitle: "A identificar", systemType: "energia", status: "a_validar", xPercent: 69, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 40 },
  { title: "Ponto de infraestrutura 05", subtitle: "A identificar", systemType: "arrefecimento", status: "a_validar", xPercent: 72, yPercent: 51, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 50 },
  { title: "Ponto de infraestrutura 06", subtitle: "A identificar", systemType: "pessoa", status: "a_validar", xPercent: 72, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 60 },
  { title: "Ponto de infraestrutura 07", subtitle: "A identificar", systemType: "arrefecimento", status: "a_validar", xPercent: 75, yPercent: 54, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 70 },
  { title: "Ponto de infraestrutura 08", subtitle: "A identificar", systemType: "agua_mar", status: "a_validar", xPercent: 78, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 80 },
  { title: "Ponto de infraestrutura 09", subtitle: "A identificar", systemType: "pessoa", status: "a_validar", xPercent: 80, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 90 },
  { title: "Ponto de infraestrutura 10", subtitle: "A identificar", systemType: "hall_ti", status: "a_validar", xPercent: 80, yPercent: 60, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 100 },
  { title: "Ponto de infraestrutura 11", subtitle: "A identificar", systemType: "arrefecimento", status: "a_validar", xPercent: 82, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 110 },
  { title: "Ponto de infraestrutura 12", subtitle: "A identificar", systemType: "hall_ti", status: "a_validar", xPercent: 87, yPercent: 56, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 120 },
  { title: "Ponto de infraestrutura 13", subtitle: "A identificar", systemType: "hall_ti", status: "a_validar", xPercent: 88, yPercent: 60, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 130 },
  { title: "Ponto de infraestrutura 14", subtitle: "A identificar", systemType: "agua_mar", status: "a_validar", xPercent: 97, yPercent: 34, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Posição inicial baseada na marcação aprovada; pode ser reposicionada.", isFuture: false, sortOrder: 140 },
...
export const appRouter = router({
  ...
  operation: router({
    ...
    replaceInfrastructureReferencePoints: protectedProcedure
      .input(z.object({ projectId: z.number().int().positive() }))
      .mutation(async ({ ctx, input }) => {
        assertAdminOnly(ctx.user);
        await assertOperationAccess(ctx.user, input.projectId);
        const database = await db.getDb(); if (!database) throw new TRPCError({ code: "INTERNAL_SERVER_ERROR" });
        const result = await database.transaction(async (tx: any) => {
          const existingResult = await tx.execute(sql`SELECT id, title FROM operation_infrastructure_points WHERE projectId = ${input.projectId} ORDER BY sortOrder ASC, id ASC`);
          const previous = (existingResult as any)[0] || [];
          await tx.execute(sql`DELETE FROM operation_infrastructure_points WHERE projectId = ${input.projectId}`);
          await tx.insert(schema.operationInfrastructurePoints).values(INFRASTRUCTURE_REFERENCE_POINTS.map((point) => ({
            projectId: input.projectId, title: point.title, subtitle: point.subtitle, systemType: point.systemType, status: point.status, xPercent: point.xPercent, yPercent: point.yPercent, description: point.description, metricCodesJson: JSON.stringify(point.metricCodes), chartMetricCode: point.chartMetricCode, technicalNote: point.technicalNote, isFuture: point.isFuture, sortOrder: point.sortOrder, createdBy: ctx.user.id, updatedBy: ctx.user.id,
          })));
          return { previousCount: previous.length };
        });
        await db.insertAuditLog(ctx.user.id, getUserDisplayName(ctx.user), "operation_infrastructure_reference_replaced", "operation_infrastructure", input.projectId, JSON.stringify({ replacedPoints: result.previousCount }), JSON.stringify({ source: "yellow_marker_layout", count: INFRASTRUCTURE_REFERENCE_POINTS.length }));
        return { success: true, count: INFRASTRUCTURE_REFERENCE_POINTS.length, replaced: result.previousCount };
      }),
