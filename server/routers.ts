...
export const INFRASTRUCTURE_REFERENCE_POINTS = [
  ...
  { title: "Ponto de infraestrutura 07", subtitle: "A identificar", systemType: "infraestrutura", status: "a_validar", xPercent: 75, yPercent: 54, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 70 },
  { title: "Ponto de infraestrutura 08", subtitle: "A identificar", systemType: "infraestrutura", status: "a_validar", xPercent: 78, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 80 },
  { title: "Ponto de infraestrutura 09", subtitle: "A identificar", systemType: "infraestrutura", status: "a_validar", xPercent: 80, yPercent: 55, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 90 },
  { title: "Ponto de infraestrutura 10", subtitle: "A identificar", systemType: "infraestrutura", status: "a_validar", xPercent: 80, yPercent: 60, description: "Marcador amarelo de referência. Configure o conteúdo técnico aprovado para este local.", metricCodes: [], chartMetricCode: null, technicalNote: "Confirme a infraestrutura e associe métricas só depois de validação técnica.", isFuture: false, sortOrder: 100 },
